...
class Sprite(Turtle):
   ...
   def set_move(self, x_start, y_start, x_end, y_end):
       ...
       self.setheading(self.towards(x_end, y_end)) #dirección
  
   def make_step(self):
       self.forward(self.step) #dirección ya presente
 
       if self.distance(self.x_end, self.y_end) < self.step: #si la distancia es menor que la mitad de un paso
           self.set_move(self.x_end, self.y_end, self.x_start, self.y_start) #cambiar dirección
